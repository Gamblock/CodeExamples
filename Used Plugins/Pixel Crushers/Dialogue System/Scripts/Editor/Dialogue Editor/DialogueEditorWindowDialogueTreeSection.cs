...
namespace PixelCrushers.DialogueSystem.DialogueEditor
{
    ...
    public partial class DialogueEditorWindow
    {
        ...
        private bool FullCheckDoesDialogueEntryHaveEvent(DialogueEntry entry)
        {
            ...
            if (entry.onExecuteEvents20 != null && entry.onExecuteEvents20.GetPersistentEventCount() > 0) return true;
        ...
        private SerializedProperty onExecutePropertyEvents20 = null;
        ...
        private void ResetUnityEventSection()
        {
            ...
            onExecutePropertyEvents20 = null;
        }
        ...
        private void DrawUnityEvents()
        {
            ...
            if (serializedObjectCurrentEntry != currentEntry)
            {
                ...
                onExecutePropertyEvents20 = entryProperty.FindPropertyRelative("onExecuteEvents20");
            }
            ...
            if (onExecutePropertyEvents20 != null)
            {
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(onExecutePropertyEvents20);
                if (EditorGUI.EndChangeCheck()) serializedObject.ApplyModifiedProperties();
            }
