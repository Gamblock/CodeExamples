...
namespace PixelCrushers.DialogueSystem.Articy
{
    ...
    public static class ConverterPrefsTools
    {
        ...
        private const string ArticyCopyLocalFieldsKey = "PixelCrushers.DialogueSystem.ArticyCopyLocalFields";
        ...
        public static ConverterPrefs Load()
        {
            ...
            converterPrefs.CopyLocalFields = EditorPrefs.GetBool(ArticyOverwriteKey, false);
        ...
        public static void Save(ConverterPrefs converterPrefs)
        {
            ...
            EditorPrefs.SetBool(ArticyCopyLocalFieldsKey, converterPrefs.CopyLocalFields);
